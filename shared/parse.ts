...
export function parseShoppingText(text: string): { name: string; quantity: number | null; unit: string } {
  ...
  return { name: capitalize(s.trim()), quantity: quantity && quantity > 0 ? quantity : null, unit };
}
